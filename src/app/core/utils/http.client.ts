...
export class NHttpClinet {
  ...
  parseHeaders(): HttpHeaders {
    ...
    eyJzdWIiOiIxMjM0NTY3ODkwIiwidXNlcm5hbWUiOiLmnajlkJsiLCJpYXQiOjE1MTYyMzkwMjJ9.T1Hvf_v_isIGLXKPNE_1UvFzO5CL9r0ybjr5C-pC4jM';
    let res = new HttpHeaders();
    if (token) {
      res = res.set('Authorization', token);
    }
    return res;
  }
  ...
  get<T>(url: string, params?: any): Observable<T> {
    this.begin();
	  console.log("get request:", this.parseHeaders());
    return this.http
      .get(url, {
